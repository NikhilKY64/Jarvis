...
def System(command):
    ...
    def mute():
        keyboard.press_and_release("volume mute") # Simulate the volume mute key press.
...
async def TranslateAndExecute(commands: list[str]):
    ...
    for command in commands:
        ...
        if command.startswith("open "):  # Handle "open" commands.
            ...
            fun = asyncio.to_thread(System, command.removeprefix("system ")) # Schedulesystem command.
            funcs.append(fun)
