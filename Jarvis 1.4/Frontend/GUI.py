...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        home_button.setStyleSheet("height:40px; line-height:40px ; background-color:grey; color: black")
        message_button = QPushButton()
        message_icon = QIcon(GraphicsDirectoryPath("Chats.png"))
        message_button.setIcon(message_icon)
        message_button.setText("  Chat")
        message_button.setStyleSheet("height:40px; line-height:40px; background-color:grey; color: black")    
        minimize_button = QPushButton()
        minimize_icon = QIcon(GraphicsDirectoryPath('Minimize2.png'))
        minimize_button.setIcon(minimize_icon)
        minimize_button.setStyleSheet("background-color:grey")
        ...
        title_label.setStyleSheet("color:black; font-size: 18px;; background-color:grey")
